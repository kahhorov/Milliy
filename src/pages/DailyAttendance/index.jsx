    ...
    >
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            <h1 className="text-[17px] md:text-3xl font-black italic tracking-tighter flex items-center gap-2">
              {t("Daily")}{" "}
                ...
                header={
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center w-full pr-4 gap-4">
                    <div className="flex items-center gap-4">
                      <div className="mt-3 md:mt-0 p-3 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-2xl text-white shadow-lg shadow-cyan-500/20">
                        <LuUsers size={22} />
                      </div>
                      <div>
                        <div className="inline md:flex items-center gap-2">
                          <h3 className="absolute top-1 left-6 md:static text-base font-black tracking-tight">
                            {group.groupName}
                          </h3>
                          {/* Rasm 1 dagi kabi "Saturday" styling */}
                          <div className="absolute top-1 right-3 md:static flex items-center gap-1.5 px-2.5 py-1 bg-cyan-100 dark:bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 rounded-xl">
